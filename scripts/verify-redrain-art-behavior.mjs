...
async function open({pageIndex=3, mobile=false, fallback=false, delayed=false}={}) {
  ...
  if(delayed) await page.route('**/public/assets/optimized/portrait-main.d069df1853ce3e2c.webp',async route=>{await new Promise(r=>setTimeout(r,1500));try{await route.continue();}catch{}});
